...
public class AppFrame extends JFrame {
        ...
        public void doExit() {
                // // Check if the application should ask for confirmation before exiting
                // if ("yes".equalsIgnoreCase(Configuration.get("ASK_ON_EXIT"))) {
                // int response = JOptionPane.showConfirmDialog(this,
                // "Are you sure you want to exit?", "Exit Confirmation",
                // JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);

                // if (response != JOptionPane.YES_OPTION) {
                // return; // Stop the exit process if the user selects "No"
                // }
                // }

                // // Save application state or perform any shutdown tasks
        ...
        // // Example: Save window position and size
        // Context.put("FRAME_WIDTH", getWidth());
        // Context.put("FRAME_HEIGHT", getHeight());
        // Context.put("FRAME_XPOS", getX());
        // Context.put("FRAME_YPOS", getY());

        // // Notify any listeners about the exit
        // notifyExitListeners();
        // }
